    ...
    <div className="px-5 pt-6 pb-10 max-w-2xl mx-auto">
      ...
      <div className="space-y-5 text-sm leading-relaxed">
        {[
          ...
          { title: 'Emergency Situations', body: 'If you are experiencing a medical emergency, severe symptoms, or mental health crisis, please contact or visit your nearest hospital immediately. Do not rely on this App in emergencies.' },
