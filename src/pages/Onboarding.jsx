              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    >-</Button>
                    <span className="text-3xl font-heading font-bold text-primary w-16 text-center">
                      {cycleLength}
                    </span>
                    <Button
                      variant="outline"
            ...
            <Card className="p-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Don't worry if you're not sure — an approximate date works!
                </p>
              </div>
            </Card>
          )}
      ...
      <div className="flex gap-3 mt-8 w-full max-w-sm">
        {step > 0 && (
          <Button
            ...
            className="rounded-xl flex-1 font-heading font-bold"
          >
        ...
        {step < steps.length - 1 ? (
          ...
          <Button
            ...
            disabled={!lastPeriodDate || saving}
            className="rounded-xl flex-1 font-heading font-bold"
          >
